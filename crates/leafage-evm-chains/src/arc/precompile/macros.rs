...
macro_rules! precompile {
    ($fn_name:ident, $precompile_input:ident, $hardfork_flags:ident; {
        ...
        pub(crate) fn $fn_name(
            $precompile_input: alloy_evm::precompiles::PrecompileInput<'_>,
            ...
            let result: Result<revm::precompile::PrecompileOutput, $crate::arc::precompile::helpers::PrecompileErrorOrRevert> = match selector {
                $(
