...
/// of `getAddressCode` / `getStorageAt` / `getAddressBalance` /
/// `getAddressNonce` reads against one state view of a fixed block.
/// The parameter and result are hex-encoded BSRB/1
